...
//These functions are for controll CE and CSN pins which are selected in nrf24_config.h
 ...
 * This function must be used after "nrf24EnableDynamicPayload(uint8_t en)" function
 */
